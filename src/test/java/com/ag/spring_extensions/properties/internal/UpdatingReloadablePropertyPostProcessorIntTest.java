...
import com.ag.spring_extensions.properties.testBeans.ReloadingAutowiredPropertyBean;
...
public class UpdatingReloadablePropertyPostProcessorIntTest extends AbstractJUnit4SpringContextTests {
	...
	public void cleanUp() throws Exception {
		...
		Thread.sleep(10000); // this is a hack -> I need to find an alternative
	...
	public void shouldReloadAlteredStringProperty() throws Exception {
        ...
        String stringProperty = this.applicationContext.getBean(ReloadingAutowiredPropertyBean.class).getStringProperty();

		assertThat(stringProperty, is("Altered Injected String Value"));
	}
}
